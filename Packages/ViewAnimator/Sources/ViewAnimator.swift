...
public extension UIView {
    ...
    ///   - options: UIView.AnimationsOptions to pass to the animation block. 
    ///   Timing functions will have no impact on spring based animations.
    ...
    static func animate(views: [UIView],
        ...
        performAnimation(views: views, animations: animations, reversed: reversed,
                         initialAlpha: initialAlpha, delay: delay, animationBlock: { view, index, dispatchGroup in
